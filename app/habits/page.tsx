  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
      ...
      <button
        ...
        className="fixed bottom-[calc(6rem+env(safe-area-inset-bottom))] right-4 flex h-14 w-14 items-center justify-center rounded-full bg-vanta-accent text-vanta-bg shadow-[0_12px_32px_-8px_rgba(201,162,75,0.5)] transition-opacity hover:opacity-90 md:bottom-8 md:right-8"
      >
